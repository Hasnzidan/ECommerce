    ...
    public partial class AddProductTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Name", "Description", "Price", "IsAvailable" },
                values: new object[,]
                {
                    { "Sample Product 1", "This is a sample product description", 99.99m, true },
                    { "Sample Product 2", "Another sample product description", 149.99m, true }
                });
        }
